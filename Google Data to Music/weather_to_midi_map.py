...
def get_info():
    ...
    for i in range(100):
        ...
        fake_response = {"temperature":random.randint(75,80),
        "apparentTemperature":random.randint(75, 80),
        "dewPoint":random.randint(69,80),
        "humidity":random.randint(1,2),
        "visibility": random.randint(8,10),
        "ozone": random.randint(300,320),
        "windBearing":random.randint(200,210)}

        # hourly.append(r.json()["hourly"]["data"][i])
        hourly.append(fake_response)
